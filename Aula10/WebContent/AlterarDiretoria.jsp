...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>SistemaICEQ - Alterar Diretor(a)</title>
        ...
        <body>
                ...
                <div id="main" class="container">
                    <h3 class="page-header">Alterar Diretor(a) #${diretoria.id }</h3>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="unidade" id="endereco" required maxlength="100" placeholder="informe a unidade">
                </div>
			...
			<select id="permissao" name="permissao" class="form-control"  onchange="ChamarLink();">
                        ...
                        <div id="actions" class="row">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary" name="command" value="AlterarDiretoria">Salvar</button>
                                <a href="ListarDiretoria.jsp" class="btn btn-default">Cancelar</a>
                            </div>
                        </div>
                    </form>
                </div>
